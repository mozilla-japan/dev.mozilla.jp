  ...
  <div class="about">
    <?php if (have_posts()) : ?>
	  <div class="navigation">
		  <div class="alignleft">
		    <?php next_posts_link(__('&laquo; 前の記事へ', 'kubrick')); ?></div>
		  <div class="alignright">
		    <?php previous_posts_link(__('新しい記事へ &raquo;', 'kubrick')); ?></div>
	  </div>
	  ...
	  <?php endwhile; ?>
	  <div class="navigation">
		  <div class="alignleft"><?php next_posts_link(__('&laquo; 前の記事へ', 'kubrick')); ?></div>
		  <div class="alignright"><?php previous_posts_link(__('後の記事へ &raquo;', 'kubrick')); ?></div>
	    <?php else :
