...
<article id="content" role="main">
  ...
  <h1 class="post-title"><?php
    the_search_query(); ?> の検索結果 <small><?php 
  ...
  <article class="searchresult-article">
    <header>
      <h1 class="searchresult-article-title"><?php
          $title = get_the_title(); ?><a href="<?php
		  the_permalink() ?>" title="<?php echo esc_attr($title);
		  ?>"><?php echo esc_html($title); ?></a></h1>
    </header>
    <footer>
